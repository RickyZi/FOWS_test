...
def plot_real_vs_fake_predictions(prob_original, prob_ghost,  thresh, plot_path, tags): #prob_simswap, prob_ghost, prob_facedancer,
    ...
    # plt.plot(original_predictions[:100], label='Original Predictions', alpha=0.8)
    # plt.plot(ghost_predictions[:100], label='Ghost Predictions', alpha=0.8)
    # plt.axhline(0.5, color='k', linestyle='--', label='Threshold = 0.5')  # Add threshold line
    # plt.title('Original vs Ghost Predictions')
    # plt.xlabel('Frames')
