...
#     print('user:', user_name)
#     for root, dirs, files in os.walk(path):
#         # if 'original_faces\obj_occlusion_' in root:
#         # if 'original_faces\hand_occlusion_' in root or 'original_faces\obj_occlusion_' in root:
#         if '_faces\hand_occlusion_' in root or '_faces\obj_occlusion_' in root:
#             # print("root:", root)
#             # root is the path to the challenge folder (hand_occlusion_1, hand_occlusion_2, hand_occlusion_3) for each algorithm
#             if dirs and root.split('\\')[-1] != user_name: 
#                 print("algo:", root.split('\\')[-1])   
...
#                     # create folder for the challenge (hand_occlusion_1, hand_occlusion_2, hand_occlusion_3)
#                     os.makedirs(save_path + folder_name) 
#                     # create new subdirectories face and no_face
#                     os.makedirs(save_path + folder_name + '/face') # user_id\algo_name\challenge_name\face
#                     os.makedirs(save_path + folder_name + '/no_face') # user_id\algo_name\challenge_name\no_face
#                     # os.makedirs(save_path + 'occlusion' + folder_name) # user_faces_preprocessing\occlusion\user_id\algo_name\challenge_name
#                     # os.makedirs(save_path + 'no_occlusion' + folder_name) # user_faces_preprocessing\no_occlusion\user_id\algo_name\challenge_name
#                 else:
#                     print("folder already exists")
#                     continue
...
#                 print("start face detection in folder:", folder_name)
#                 for file in files_path:
#                     face_detection(file, save_path + folder_name)
#             else: 
#                 continue
#         else:
#             continue
