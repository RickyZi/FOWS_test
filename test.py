...
def main(): 
    ...
    # NOTE: default is the pretrained baselines folders. Change the path to were your trained model was saved (i.e. ./results/)

    model, model_name = get_pretrained_model(args) 
